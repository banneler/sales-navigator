...
**Plans:** **CC Pro** and **CC Elite** as **concurrent** seats, bundled with UC or standalone—admin portal, supervisor app, real-time agent status, inbound voice queues, ACD, queue position/ETA, supervisor monitor/whisper/barge, reporting/analytics. **Elite** extends capability—**confirm current matrix** before customer commitments. Digital channels (chat, email, WhatsApp) and Dynamic Notifications often **add-ons**; **bursting/elastic** rules are **internal** sizing—not napkin math.

**Features:** skills-based routing, queued callback, preferred-agent routing, drag-and-drop IVR, CRM/WFM integrations, dashboards, wallboards, monitoring, surveys, outbound dialer, AI agent evaluator, screen recording—position what matches maturity.
...
**PRI:** digital trunking for medium/large sites; multiple voice paths and features (e.g., Caller ID). **POTS:** traditional landline—clarity, reliability, **911** access independent of mobile battery where applicable.
