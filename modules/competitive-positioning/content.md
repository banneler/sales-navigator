...
1. **Discovery** — apps, sites, outcomes, topology, migration, decision owners.
2. **Map** — tie strengths/weaknesses to *their* stated needs.
3. **Competitor → GPC** — their angle; risk *for this account*; proof you can support (local, NOC, fiber design, symmetry, portfolio)—only what discovery supports.
...
**Proof:** concrete (build, redundancy, commercial terms) > generic; outcome-led; verify awards externally; keep directional stats internal.
...
*Guidde:* competitive talk track or single-vertical battle-card walkthrough.
